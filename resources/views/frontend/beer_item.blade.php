<div class="col-12 beer-list__beer">
    <div class="beer-list__beer__image">
        <img src="{{ count($beer->labels) && $beer->labels[0]->sticker ? $beer->labels[0]->sticker->thumbnail() : URL::asset('img/label-template.jpg') }}"/>
    </div>
    <div class="beer-list__beer__data">
        ...
        @if (count($beer->labels)) <div class="badge badge-secondary">{{ $beer->labels[0]->year }}</div> @endif
    </div>
</div>
