...
class BrewerController extends Controller
{
    private $private_methods = [
        'newBrewer', 'createBrewer', 'ajaxCreateBrewer', 'updateBrewer'
    ];
    ...
    {
        list($name, $city_name, $country_name, $data) = $this->getFormParams($request);
    ...
    public function editBrewer($id)
    {
        $brewer = $this->brewer_repository->findById($id);
        return view('dashboard.brewer.form', ['brewer' => $brewer]);
    }

    public function updateBrewer(Request $request, int $id)
    {
        list($name, $city_name, $country_name, $data) = $this->getFormParams($request);
    ...
    public function ajaxCreateBrewer(Request $request)
    {
    ...
    private function getFormParams(Request $request): array
    {
